            ...
            <ul className="space-y-4">
              ...
              <li>
                <Link
                  ...
                  className={`block text-lg font-medium py-2 px-4 rounded-lg transition ${
                    pathname === '/' ? 'bg-[#f2f0eb] text-[#1f3b2c] font-semibold' : 'text-[#2c2b28] hover:bg-[#f2f0eb]'
                  }`}
                  onClick={() => setIsMenuOpen(false)}
                >
                  Home
              ...
              <li>
                <Link
                  href="/about"
                  className={`block text-lg font-medium py-2 px-4 rounded-lg transition ${
                    pathname === '/about' ? 'bg-[#f2f0eb] text-[#1f3b2c] font-semibold' : 'text-[#2c2b28] hover:bg-[#f2f0eb]'
                  }`}
                  onClick={() => setIsMenuOpen(false)}
                >
                  About
              ...
              <li>
                <button
                  ...
                  className={`flex items-center justify-between w-full text-lg font-medium py-2 px-4 rounded-lg transition ${
                    isProductsActive ? 'bg-[#f2f0eb] text-[#1f3b2c] font-semibold' : 'text-[#2c2b28] hover:bg-[#f2f0eb]'
                  }`}
                >
                  <span>Shop</span>
                  <svg 
